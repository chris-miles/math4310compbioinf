...
| | |
|:--|:--|
| Course | MATH 4310 · Section {{section}} · Computational Bioinformatics |
| Class number | {{class_number}} |
| Term | {{term}} |
| Credits | {{credits}} |
| Format | {{format}} |
| Instructor | [Chris Miles](https://profiles.faculty.utah.edu/u0881186) |
| Meetings | {{meeting_days}}, {{meeting_time}} |
| Classroom | {{room}} |
...
- CS 1410 — introductory object-oriented programming
...
- Analyze the correctness and computational complexity of dynamic programming algorithms for sequence alignment.
